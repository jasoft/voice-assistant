...
def temp_db(tmp_path):
    ...
    store = SQLiteFTS5RememberStore(db_path=db_path, user_id="default")
    return store
...
async def test_agent_date_extraction():
    ...
    cfg = parse_args(["--user-id", "default", "--openai-api-key", "fake", "--base-url", "http://localhost:8000/v1", "--model", "fast"])
